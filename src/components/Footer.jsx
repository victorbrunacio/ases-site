...
const Footer = () => {
  return (
    <footer className='text-gray-100 text-[0.6rem] w-full flex flex-col items-center  justify-center  bg-gray-700 
    ...
    '>
      <div className=' w-full flex px-10 items-center justify-center bg-black p-2 z-11'>
        ...
        <div className=' w-full flex px-10 items-center justify-center bg-black p-2'>
          ...
          <div className='flex w-full flex-col items-center  gap-1'>
            ...
            <p className='text-[0.5rem] '>Atendimento somente para Pessoa Jurídica</p>

            <img src={meioPagamento} alt="img pagamentos" className='h-2.5 mb-2' />
            <hr className='w-52 rounded border border-white' />
            <h3>BOLETOS</h3>
            <p className='text-[0.5rem]'>Retirada de 2º via ou atualização de boletos.</p>
            <div className='flex '>
      ...
      <div className='flex flex-col gap-5 items-center p-4 text-[0.5rem] text-gray-200 justify-center'>
