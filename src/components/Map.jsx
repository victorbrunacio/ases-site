...
const Map = () => {
    ...
    return (
        ...
        <div className=' w-full flex  items-center  p-10  mt-20
        max-md:flex-col gap-5 justify-evenly  
        ' >
            ...
            <div className='text-sm flex flex-col items-center justify-center gap-10
            max-md:text-xs
            '>
                <div>
