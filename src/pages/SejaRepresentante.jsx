...
const SejaRepresentante = () => {
    ...
    return (
        <div className="flex p-10   text-[0.6rem] justify-center
        max-md:pl-1">
            <div>
            <h1 className='text-xl underline underline-offset-8 font-bold pb-1 m-auto
            max-md:underline max-md:underline-offset-8 max-md:font-serif max-md:ml-3'>
        Seja um Representante
      </h1>
            <motion.img src={homenTrabalho} alt="homenTrabalho" className='rounded h-80 shadow-2xl mt-10 cursor-pointer
